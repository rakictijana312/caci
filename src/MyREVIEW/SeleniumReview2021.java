...
public class SeleniumReview2021 {
    ...
    Advantages of using Selenium:
     ...
     When we want to automate the test Case on Internet Explorer sometimes CssSelector is
     ...
     ● Speed wise CSS and XPATH can be equal, or either one would be a bit speedier than the
     other.Therefore speed comparison can be ignored. However, off the record, I have
     encountered that CSS is much faster than XPATH in IE Browser.
    ...
    30. How to Upload a file in Selenium WebDriver? How to Download a file in Selenium WebDriver?
